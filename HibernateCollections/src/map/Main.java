...
public class Main {
    public static void main(String[] args) {
        ...
        Map addresses1= new HashMap();
        Map addresses2= new HashMap();
        
        addresses1.put("addr1", ad1);
        addresses1.put("addr2", ad3);
        
        addresses2.put("addr1", ad2);
        addresses2.put("addr2", ad4);
        ...
        Collection c= a1.values();
        Iterator itr= c.iterator();
        while(itr.hasNext())
        {
        	Address ad=(Address)itr.next();
